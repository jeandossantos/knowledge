      ...
      <b-form>
          ...
          <b-row>
              ...
              <b-col md="6" sm="12"> 
                  <b-form-group label="E-mail:" label-for="user-email">
                      ...
                      v-model="user.email" required :readonly="mode === 'remove'" placeholder="Informe o E-mail do Usuário..."/>
                  </b-form-group>
              </b-col>
          </b-row>
          <b-row v-show="mode === 'save'">
           ...
           <b-row v-show="mode === 'save'">
              ...
              <b-col md="6" sm="12"> 
                  <b-form-group label="Corfirmação de Senha:" label-for="user-confirm-password">
